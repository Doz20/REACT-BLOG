...
class SignIn extends Component{
    render(){
        return(
          <>
          <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 h-screen lg:px-8 bg-dark text-dark-text">
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
              <form className="space-y-6" action="#" method="POST">
                <div>
                  <label htmlFor="email" className="block text-sm font-medium leading-6 text-gray-300 text-left">
                    Email address
                  </label>
                  <div className="mt-2">
                    <input
                ...
                <div>
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-sm">
                     <Link to="/forget"
                  className="font-semibold text-dark-text hover:text-indigo-500">
                        Forgot password?
                     </Link>
                    </div>
                  </div>
